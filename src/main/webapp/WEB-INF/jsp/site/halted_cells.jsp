                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    ...
                                    <table id="halted-sites-table" class="table">
...
<script>
    ...
    $(document).ready(
        drawHaltedSitesTable()
    );

    function drawHaltedSitesTable() {



        var  haltedSiteTable = $("#halted-sites-table").DataTable({
            "processing": true,
            'language': {
                'loadingRecords': '&nbsp;',
            ...
            "serverSide": true,
            "ordering": true,
            "aLengthMenu": [[25, 100, 250 , 1000000], [25, 100, 250, "All"]],
            "iDisplayLength": 20,
            "ajax": "../load/getHaltedSites",
            "dom": 'lBfrtip',
            "buttons": [
                {
                    extend: 'collection',
