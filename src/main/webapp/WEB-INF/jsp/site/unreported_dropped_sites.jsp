                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="tables">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item"> <a class="nav-link" href="/NetworkMonitoringCenter/load/droppedSites">Current Dropped Sites</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample">
                            <div class="form-group">
                                ...
                                <input id ="noteID"type="text" class="form-control" id="exampleInputName1" placeholder="Note">
                            </div>

                            <div class="form-group">
                                <label for="exampleSelectGender">Reason</label>
                                <select class="form-control" id="exampleSelectGender">
                                    <option value="Enerji">Enerji</option>
                                    <option value="Transmissiya">Transmissiya</option>
                                    <option value="Tetbiq Ishleri">Tetbiq Ishleri</option>
                                    <option value="Fealiyyeti dayandirilib">Fealiyyeti dayandirilib</option>
                                    <option value="Hardware xetasi">Hardware xetasi</option>
                                    <option value="Yuksek temperatur">Yuksek temperatur</option>
                                    <option value="Xebersiz kesinti">Xebersiz kesinti</option>
                                </select>
                            </div>
                            <button id="updateButton" type="submit" class="btn btn-primary mr-2">Update</button>
                        ...
                        <h4 class="card-title">Dropped Sites</h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    ...
                                    <table id="dropped-sites-table" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <th>Node</th>
                                            <th>Cell</th>
                                            <th>Occur Date and Time</th>
                                            <th>Ceasing Date and Time</th>
                                            <th>Status</th>
                                        </tr>
                                        </thead>
...
<script>
    ...
    $(document).ready(function () {
        ...
        drawDroppedSitesTable();



        $("#dropped-sites-table").on('click', 'tr', function () {
    ...
    function drawDroppedSitesTable() {
         ...
         droppedSiteTable = $("#dropped-sites-table").DataTable({
            "processing": true,
           'language': {
               'loadingRecords': '&nbsp;',
