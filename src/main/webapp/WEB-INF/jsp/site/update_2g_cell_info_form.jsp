                ...
                <div class="row">
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <form:form  id="example-vertical-wizard" action ="/load/update2GCellInfo" method="post" modelAttribute="site">
                                    <div>
                                        ...
                                        <section>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="form-group">
                                                        <form:label path="rblt">E1</form:label>
                                                        <form:input path="rblt" class="form-control"/> <br/>
                                                            <%--<label>E1</label>--%>
                                                            <%--<input type="password" class="form-control" placeholder="">--%>
                                                    </div>
                                                    <div class="form-group">
...
<%--                                                        <input type="password" class="form-control" placeholder="">--%>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <form:input path="insDate" class="form-control"/> <br/>
