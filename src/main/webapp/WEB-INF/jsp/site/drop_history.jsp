        ...
        <div class="main-panel">
            ...
            <div class="content-wrapper">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Drop History</h4>
                        <div class="row">
                            <div class="col-12">
                                <div class="table-responsive">
                                    <table id="drop-history-table" class="table">
                                        <thead>
                                        <tr>
                                            <th>Node</th>
                                            <th>Cell Type</th>
...
<script>
    ...
    $(document).ready(
        drawDropHistoryTable()
    );

    function drawDropHistoryTable() {



        var  dropHistoryTable = $("#drop-history-table").DataTable({
            "processing": true,
            'language': {
                'loadingRecords': '&nbsp;',
